onEvent("recipes", (event) => {
    ...
    */
    ...
    // crystal disassembly
    const crystal_disassemble_20 = (type, item_1, item_9) => {
        event.shaped(`20x ${item_1}`, ["c"], {
     ...
     */
    const crystalize_prec = (type, normal, washed, crystal, amount, amount_s) => {
        event.custom(
